...
df_p = dp.data_prep(df, '[9, 13, 16, 21]')

res_prob = dp.probabilities(df_p, df,  [9, 13, 16, 21], 5100, 6600)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [9, 13, 16, 21], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_7_9_13_16_21')