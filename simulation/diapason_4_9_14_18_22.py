...
df_p = dp.data_prep(df, '[9, 14, 18, 22]')

res_prob = dp.probabilities(df_p, df, [9, 14, 18, 22], 2700, 3300)
...
stats = sim.model_percent(check_sum,  10000, res_prob[0], res_prob[1], [9,14,28,22], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_4_9_14_18_22')