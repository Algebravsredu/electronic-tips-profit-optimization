...
df_p = dp.data_prep(df, '[10, 14, 19, 24]')

res_prob = dp.probabilities(df_p, df, [10, 14, 19, 24], 4100, 5100)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [10,14,19,24], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_6_10_14_19_24')