...
df = pd.read_csv('/Users/Egor/Downloads/diapason_0_new.csv')
df = df[df['values'] == '[50, 100, 150, 200]']
df_p = dp.data_prep(df, '[50, 100, 150, 200]')

res_prob = dp.probabilities(df_p, df, [50, 100, 150, 200], 0, 1000)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_0_50_100_150_200_new')