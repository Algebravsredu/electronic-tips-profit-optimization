...
df_p = dp.data_prep(df, '[170, 290, 300, 350]')

res_prob = dp.probabilities(df_p, df, [170, 290, 300, 350], 3300, 4100)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [170, 290, 300, 350], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_5_170_290_300_350')