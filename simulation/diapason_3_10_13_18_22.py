...
df_p = dp.data_prep(df, '[10, 13, 18, 22]')
res_prob = dp.probabilities(df_p, df, [10, 13, 18, 22], 2100, 2700)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [10,13,18,22], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_3_10_13_18_22')