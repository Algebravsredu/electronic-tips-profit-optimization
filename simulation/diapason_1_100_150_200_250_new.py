...
df = pd.read_csv('/Users/Egor/Downloads/diapason_1_new.csv')
df = df[df['values'] == '[100, 150, 200, 250]']
df_p = dp.data_prep(df, '[100, 150, 200, 250]')

res_prob = dp.probabilities(df_p, df, [100, 150, 200, 250], 1000, 1500)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [100, 150, 200, 250],df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_1_100_150_200_250_new')