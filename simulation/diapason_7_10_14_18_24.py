...
df_p = dp.data_prep(df, '[10, 14, 18, 24]')

res_prob = dp.probabilities(df_p, df,  [10, 14, 18, 24], 5100, 6600)
...
stats = sim.model_percent(check_sum, 100, res_prob[0], res_prob[1], [10, 14, 18, 24], df_0)
...
#st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_7_10_14_18_24')