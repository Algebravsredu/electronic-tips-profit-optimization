...
df = pd.read_csv('/Users/Egor/Downloads/diapason_10_new.csv')

df = df[(df['check_sum'] <= np.quantile(df['check_sum'], 0.99)) & (df['values'] == '[10, 12, 15, 20]')]
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_10_10_12_15_20_new')