...
p = dp.probabilities_random(d[0], d[1], set.index[:5], set.index, 6600, 9000)

 # #создание массива сумм чека с исходным распределением
check_sum = []
check_sum_type = np.random.choice(range(48), 24000, p = p[3])
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_8_random')
