...
df_p = dp.data_prep(df, '[130, 200, 260, 270]')
res_prob = dp.probabilities(df_p, df, [130, 200, 260, 270], 2100, 2700)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [130,200,260,270], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_3_130_200_260_270')