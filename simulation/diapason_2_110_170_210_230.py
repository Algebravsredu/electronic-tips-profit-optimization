...
df_p = dp.data_prep(df, '[110, 170, 210, 230]')

print(df_p)
res_prob = dp.probabilities(df_p, df, [110, 170, 210, 230], 1500, 2100)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [110,170,210,230],df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_2_110_170_210_230')