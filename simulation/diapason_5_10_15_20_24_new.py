...
df = pd.read_csv('/Users/Egor/Downloads/diapason_5_new.csv')

df = df[df['values'] == '[10, 15, 20, 24]']
df_p = dp.data_prep(df, '[10, 15, 20, 24]')

res_prob = dp.probabilities(df_p, df, [10, 15, 20, 24], 3300, 4100)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [10,15,20,24], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_5_10_15_20_24_new')