...
df_p = dp.data_prep(df, '[490, 890, 1190, 1240]')
...
res_prob = dp.probabilities(df_p, df, [490, 890, 1190, 1240], 14900, right)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [490, 890, 1190, 1240], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_10_490_890_1190_1240')