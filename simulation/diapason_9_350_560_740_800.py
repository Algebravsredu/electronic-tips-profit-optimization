...
df_p = dp.data_prep(df, '[350, 560, 740, 800]')

res_prob = dp.probabilities(df_p, df, [350, 560, 740, 800], 9000, 14900)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [350, 560, 740, 800], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_9_350_560_740_800')