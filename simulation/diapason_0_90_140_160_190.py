...
df_p = dp.data_prep(df, '[90, 140, 160, 190]')

res_prob = dp.probabilities(df_p, df, [90, 140, 160, 190], 0, 1000)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [90, 140, 160, 190], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_0_90_140_160_190')