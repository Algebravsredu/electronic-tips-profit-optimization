...
def model_random(check_sum, num_simulation, type_of_comb_prob, type_of_but_prob, every_but_prob,  set_of_combinations, set_of_comb_with_type,ds_0, s_o_c, p_1):
    #подается на вход смоделированный набор сумм чека, число симуляций, вероятности предложения наборов, вероятности выбора набора или ручного ввода, вероятности выбора каждой кнопки из 4, наборы предлагаемых кнопок, наборы кнопок с типом, набор чаевых ручного ввода, 5 самых популярных наборов и вероятности для них 
    ,,
