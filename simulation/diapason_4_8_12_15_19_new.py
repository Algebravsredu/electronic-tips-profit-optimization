...
df = pd.read_csv('/Users/Egor/Downloads/diapason_4_new.csv')

df = df[df['values'] == '[8, 12, 15, 19]']
df_p = dp.data_prep(df, '[8, 12, 15, 19]')

res_prob = dp.probabilities(df_p, df, [8, 12, 15, 19], 2700, 3300)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [8,12,15,19], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_4_8_12_15_19_new')