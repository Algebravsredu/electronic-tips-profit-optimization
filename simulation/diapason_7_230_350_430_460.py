...
df_p = dp.data_prep(df, '[230, 350, 430, 460]')

res_prob = dp.probabilities(df_p, df,  [230, 350, 430, 460], 5100, 6600)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [230, 350, 430, 460], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_7_230_350_430_460')