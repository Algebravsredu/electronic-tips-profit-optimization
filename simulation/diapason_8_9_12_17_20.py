...
df_p = dp.data_prep(df, '[9, 12, 17, 20]')

res_prob = dp.probabilities(df_p, df, [9, 12, 17, 20], 6600, 9000)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [9,12,17,20], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_8_9_12_17_20')