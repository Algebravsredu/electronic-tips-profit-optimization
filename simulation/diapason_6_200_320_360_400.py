...
df_p = dp.data_prep(df, '[200, 320, 360, 400]')

res_prob = dp.probabilities(df_p, df, [200, 320, 360, 400], 4100, 5100)
...
stats = sim.model_sum(check_sum, 10000, res_prob[0], res_prob[1], [200, 320, 360, 400], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_6_200_320_360_400')