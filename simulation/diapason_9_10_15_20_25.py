...
res_prob = dp.probabilities(df_p, df, [10, 15, 20, 25], 9000, 14900)

print(df[df['type_of_selected_button'] == 1 ])
#создание массива сумм чека с исходным распределением
check_sum = []
check_sum_type = np.random.choice(range(66), 59000, p = res_prob[2])
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_9_10_15_20_25')