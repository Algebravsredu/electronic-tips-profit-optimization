...
df_p = dp.data_prep(df, '[9, 12, 15, 19]')
...
res_prob = dp.probabilities(df_p, df, [9, 12, 15, 19], 14900, right)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [9, 12, 15, 19], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_10_9_12_15_19')