...
df = pd.read_csv('/Users/Egor/Downloads/diapason_9_new.csv')
df = df[df['values'] == '[10, 13, 15, 20]']
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_9_10_13_15_20_new')