...
stats = sim.model_sum(check_sum, 1, res_prob[0], res_prob[1], [50,100,150,200], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_0_50_100_150_200')