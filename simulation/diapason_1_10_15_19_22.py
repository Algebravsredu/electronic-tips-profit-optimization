...
df_p = dp.data_prep(df, '[10, 15, 19, 22]')

res_prob = dp.probabilities(df_p, df, [10, 15, 19, 22], 1000, 1500)
...
stats = sim.model_percent(check_sum, 10000, res_prob[0], res_prob[1], [10,15,19,22], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_1_10_15_19_22')