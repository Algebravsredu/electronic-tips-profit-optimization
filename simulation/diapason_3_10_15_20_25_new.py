...
df = pd.read_csv('/Users/Egor/Downloads/diapason_3_new (1).csv')
df = df[df['values'] == '[10, 15, 20, 25]']
df_p = dp.data_prep(df, '[10, 15, 20, 25]')
res_prob = dp.probabilities(df_p, df, [10, 15, 20, 25], 2100, 2700)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_3_10_15_20_25_new')