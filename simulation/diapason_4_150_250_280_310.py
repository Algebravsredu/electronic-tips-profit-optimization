...
df_p = dp.data_prep(df, '[150, 250, 280, 310]')

res_prob = dp.probabilities(df_p, df, [150, 250, 280, 310], 2700, 3300)
...
stats = sim.model_sum(check_sum,  10000, res_prob[0], res_prob[1], [150,250,280,310], df_0)
...
st.to_csv('/Users/Egor/Desktop/все/Результаты симуляций/diapason_4_150_250_280_310')